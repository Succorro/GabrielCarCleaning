...
const ServiceDetails = ({ service }: ServiceDetailsProps) => {
    ...
    return (
      <animated.div style={props} className="w-2/3 p-8 bg-white dark:bg-slate-200 shadow-lg">
        ...
        <button className="mt-6 px-4 py-2 bg-DTeal text-white rounded hover:bg-teal-800 transition duration-200">
          Book Now
        </button>
      </animated.div>
    );
